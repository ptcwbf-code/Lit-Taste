...
module.exports = [
  // —— 一、古典与神启（6）——
  { name: '🏛️ 古希腊', era: 'Ancient Greece', faith: 3, rule: 3, tribe: 7, grace: 8, mind: 9, quest: 2, edge: 3, tempo: 4, gold: 5, fire: 8, tags: '城邦、广场辩论、万物的尺度' },
  ...
  { name: '🕯️ 中世纪欧洲', era: 'Medieval Europe', faith: 10, rule: 8, tribe: 9, grace: 6, mind: 3, quest: 2, edge: 3, tempo: 4, gold: 3, fire: 3, tags: '哥特教堂、骑士与修士、彼岸' },
  { name: '📖 巴格达', era: 'Abbasid Baghdad', faith: 6, rule: 6, tribe: 6, grace: 8, mind: 9, quest: 8, edge: 3, tempo: 6, gold: 7, fire: 3, tags: '翻译运动、图书馆、智慧之宫' },
  { name: '🏺 罗马帝国', era: 'Roman Empire', faith: 3, rule: 9, tribe: 7, grace: 3, mind: 5, quest: 9, edge: 6, tempo: 6, gold: 9, fire: 7, tags: '大路与水道、法典、万邦仰望' },
  { name: '🌄 玛雅古典期', era: 'Classic Maya', faith: 9, rule: 6, tribe: 6, grace: 3, mind: 8, quest: 3, edge: 5, tempo: 3, gold: 6, fire: 4, tags: '星空历法、雨林金字塔、循环时间' },
  ...
  { name: '🍵 江户日本', era: 'Edo Japan', faith: 5, rule: 8, tribe: 6, grace: 9, mind: 5, quest: 2, edge: 4, tempo: 5, gold: 4, fire: 3, tags: '浮世绘、町人、侘寂与热闹' },
  ...
  { name: '📚 先秦诸子', era: 'Hundred Schools', faith: 7, rule: 7, tribe: 6, grace: 5, mind: 9, quest: 6, edge: 4, tempo: 3, gold: 5, fire: 2, tags: '百家争鸣、礼崩乐坏、问天下' },
  { name: '🛕 笈多印度', era: 'Gupta India', faith: 8, rule: 6, tribe: 6, grace: 8, mind: 9, quest: 2, edge: 2, tempo: 5, gold: 6, fire: 4, tags: '梵语诗、石窟、数学与灵魂' },
  ...
  { name: '🏰 伊丽莎白伦敦', era: 'Elizabethan London', faith: 2, rule: 3, tribe: 7, grace: 7, mind: 7, quest: 9, edge: 6, tempo: 6, gold: 5, fire: 8, tags: '剧场、航海图、帝国黎明' },
  { name: '💐 19世纪巴黎', era: 'Belle Époque Paris', faith: 2, rule: 3, tribe: 4, grace: 9, mind: 9, quest: 8, edge: 3, tempo: 10, gold: 3, fire: 9, tags: '咖啡馆主义、阁楼天才、波西米亚' },
  ...
  // —— 五、征途与边疆（6）——
  { name: '🪓 维京时代', era: 'Viking Age', faith: 6, rule: 2, tribe: 8, grace: 2, mind: 2, quest: 9, edge: 10, tempo: 8, gold: 2, fire: 7, tags: '长船、风暴出海、部落荣誉' },
  ...
  { name: '⚓ 大航海时代', era: 'Age of Exploration', faith: 7, rule: 3, tribe: 6, grace: 2, mind: 3, quest: 10, edge: 9, tempo: 7, gold: 9, fire: 6, tags: '海图空白、以命赌疆界、把世界画大' },

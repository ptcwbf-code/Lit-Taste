...
module.exports = [
  ...
  { name: '卡夫卡', region_era: '奥匈帝国/捷克', works: '《变形记》《审判》', narrative: 7, lyric: 6, psychology: 10, imagination: 7, society: 8, philosophy: 8, form: 10, readability: 5, humor: 5, desire: 5, tags: '荒诞、异化、制度、梦魇' },
  ...
  { name: '马尔克斯', region_era: '哥伦比亚', works: '《百年孤独》《霍乱时期的爱情》', narrative: 10, lyric: 10, psychology: 4, imagination: 10, society: 9, philosophy: 7, form: 8, readability: 5, humor: 7, desire: 7, tags: '魔幻、家族、历史、爱情' },
  ...
  { name: '沃莱·索因卡', region_era: '尼日利亚', works: '《诠释者》《死亡与国王的马夫》', narrative: 7, lyric: 8, psychology: 6, imagination: 7, society: 10, philosophy: 7, form: 7, readability: 5, humor: 7, desire: 5, tags: '非洲、神话、政治、戏剧' },
];

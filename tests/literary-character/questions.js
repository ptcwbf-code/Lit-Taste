...
module.exports = [
  ...
  { id: 7, format: 'reality', context: null,
    ...
    options: [
      { id: 'A', text: '认真跟他辩，把道理讲透。', vector: { thought: 3 } },
      { id: 'B', text: '争归争，事后还是朋友，不伤感情。', vector: { care: 2, emotion: 1 } },
  ...
  { id: 10, format: 'fantasy', context: null,
    prompt: '你捡到一本写上去愿望就能成真的书，但每个愿望都要付出代价。你会？',
    options: [
      { id: 'A', text: '兴奋地写下第一个愿望，先试了再说。', vector: { dream: 2, desire: 1 } },
      { id: 'B', text: '反复掂量：这代价到底是什么，值不值。', vector: { inner: 3 } },
      { id: 'C', text: '想：这书从哪来的，规则又是谁定的。', vector: { thought: 2 } },
      { id: 'D', text: '先收好，等一个真正值得的愿望再用。', vector: { order: 2 } },
    ] },
  ...
  { id: 14, format: 'fantasy', context: null,
    prompt: '有个声音对你说：能实现你一个最深的愿望，但你必须先放弃一样同样重要的东西。你会？',
    options: [
      { id: 'A', text: '先问清楚：我要放弃的到底是什么。', vector: { inner: 3 } },
      { id: 'B', text: '那个愿望太强烈，先答应了再说。', vector: { desire: 3 } },
      { id: 'C', text: '想：用一样东西换另一样，这买卖公平吗？', vector: { thought: 2 } },
      { id: 'D', text: '不换，守住我现在拥有的，就很好。', vector: { order: 2 } },
    ] },
  ...
  { id: 16, format: 'fantasy', context: null,
    prompt: '你得到一颗种子，种下去能长出任何你想要的东西，但要你倾注多年心血。你会？',
    options: [
      { id: 'A', text: '立刻种下，每天守着它长大。', vector: { action: 2, tough: 1 } },
      { id: 'B', text: '幻想它长成后，会结出多么不可思议的东西。', vector: { dream: 3 } },
      { id: 'C', text: '想：我最想要的，到底是什么？', vector: { thought: 2, inner: 1 } },
      { id: 'D', text: '找人一起种，一起分担这几年。', vector: { care: 2 } },
    ] },
  { id: 17, format: 'fantasy', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '给 ta 一句安慰，告诉 ta 一切都会好起来。', vector: { care: 2, emotion: 1 } },
    ] },
  { id: 18, format: 'fantasy', context: null,
    prompt: '你站在一面能通往任何地方的门前，一次只能去一个地方。你会？',
    options: [
      { id: 'A', text: '去一个从没人去过的地方。', vector: { dream: 3 } },
      { id: 'B', text: '去一个能让我变得更强的地方。', vector: { desire: 2, action: 1 } },
      { id: 'C', text: '去一个能帮助很多人的地方。', vector: { care: 3 } },
      { id: 'D', text: '哪都不去，门后未必比这里好。', vector: {}, avoid: true },
    ],
    followUp: {
      prompt: '你把手放在门把上，忽然又犹豫了。你最后会？',
      options: [
        { id: 'A', text: '推门而入，不等想清楚。', vector: { action: 2, dream: 1 } },
        { id: 'B', text: '站在门口想：门的另一边，我的人生会怎样。', vector: { thought: 2, inner: 1 } },
        { id: 'C', text: '回头看看，留在这里的人值不值得我留下。', vector: { care: 2, emotion: 1 } },
        { id: 'D', text: '不进去了，还是留在原地。', vector: {}, avoid: true },
      ],
    },
  },
  ...
  { id: 41, format: 'commitment', context: null,
    ...
    options: [
      { id: 'A', text: '认定了就不回头，继续坚持。', vector: { tough: 2, action: 1 } },

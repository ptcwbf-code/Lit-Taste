...
module.exports = [
  ...
  { id: 2, format: 'tint', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我很少注意光。', vector: {}, avoid: true },
    ] },
  { id: 3, format: 'tint', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '没注意过墙上的光。', vector: {}, avoid: true },
    ] },
  ...
  { id: 5, format: 'tint', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我一般不看天。', vector: {}, avoid: true },
    ] },
  { id: 6, format: 'tint', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '都行，无所谓。', vector: {}, avoid: true },
    ] },
  ...
  { id: 8, format: 'tint', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '能照清楚就行。', vector: {}, avoid: true },
    ] },
  ...
  { id: 10, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '睡着舒服就行。', vector: {}, avoid: true },
    ] },
  { id: 11, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '留白，什么都不挂。', vector: { numinous: 2 } },
    ] },
  ...
  { id: 13, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '能坐就行。', vector: {}, avoid: true },
    ] },
  { id: 14, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '不放，桌面空着最好。', vector: { numinous: 2 } },
    ] },
  { id: 15, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '别打开，乱就乱吧。', vector: {}, avoid: true },
    ] },
  ...
  { id: 17, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '什么包围都行，睡着就好。', vector: {}, avoid: true },
    ] },
  { id: 18, format: 'nest', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我房间没什么情绪。', vector: {}, avoid: true },
    ] },
  ...
  { id: 20, format: 'keepsake', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '旧照片我不太留。', vector: {}, avoid: true },
    ] },
  { id: 21, format: 'keepsake', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我不爱收藏。', vector: {}, avoid: true },
    ] },
  { id: 22, format: 'keepsake', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '不用，收起来就好。', vector: {}, avoid: true },
    ] },
  ...
  { id: 24, format: 'keepsake', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '很少翻旧东西。', vector: {}, avoid: true },
    ] },
  { id: 25, format: 'keepsake', context: null,
    ...
    options: [
      ...
      { id: 'C', text: '野的、不肯被驯服的。', vector: { unruly: 2 } },
      { id: 'D', text: '旧物哪来的灵魂。', vector: {}, avoid: true },
    ] },
  { id: 26, format: 'keepsake', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '不摆，空着。', vector: { numinous: 1 } },
    ] },
  ...
  { id: 28, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '舒服和实用就行。', vector: {}, avoid: true },
    ] },
  { id: 29, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '普通就好，别被注意。', vector: {}, avoid: true },
    ] },
  { id: 30, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '随便穿，不出格。', vector: {}, avoid: true },
    ] },
  { id: 31, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我没有标志色。', vector: {}, avoid: true },
    ] },
  { id: 32, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '越省事越好。', vector: {}, avoid: true },
    ] },
  { id: 33, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '心里不自在。', vector: {}, avoid: true },
    ] },
  { id: 34, format: 'garb', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '就现在这样，挺好。', vector: {}, avoid: true },
    ] },
  ...
  { id: 36, format: 'vista', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '窗外是墙也行。', vector: {}, avoid: true },
    ] },
  { id: 37, format: 'vista', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '都行，走到哪算哪。', vector: {}, avoid: true },
    ] },
  { id: 38, format: 'vista', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我没什么特别想去的地方。', vector: {}, avoid: true },
    ] },
  { id: 39, format: 'vista', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '看一眼就走了。', vector: {}, avoid: true },
    ] },
  ...
  { id: 41, format: 'vista', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '我不太独自旅行。', vector: {}, avoid: true },
    ] },
  { id: 42, format: 'vista', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '就看看眼前的生活。', vector: {}, avoid: true },
    ] },
  ...
  { id: 44, format: 'glyph', context: null,
    ...
    options: [
      ...
      { id: 'D', text: '不看，没什么好看的。', vector: {}, avoid: true },
    ] },
  { id: 45, format: 'glyph', context: null,
    ...
    options: [
      ...
      { id: 'C', text: '一个很狂的、打破规矩的图。', vector: { unruly: 3 } },

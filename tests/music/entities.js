...
module.exports = [
  ...
  { name: '🌗 另类摇滚', en: 'Alternative Rock', warmth: 4, intensity: 8, order: 5, groove: 8, nostalgia: 5, texture: 6, inward: 6, melancholy: 6, space: 5, aura: 5, tags: '边缘、多变、不归类' },
  ...
  { name: '🌧️ 垃圾摇滚', en: 'Grunge', warmth: 5, intensity: 9, order: 3, groove: 5, nostalgia: 7, texture: 1, inward: 6, melancholy: 3, space: 4, aura: 4, tags: '颓废、真实、粗粝' },
  ...
  { name: '🤘 重金属', en: 'Heavy Metal', warmth: 3, intensity: 10, order: 5, groove: 7, nostalgia: 2, texture: 2, inward: 2, melancholy: 7, space: 2, aura: 9, tags: '极致、强力、暗黑' },
  ...
  { name: '👑 华丽摇滚', en: 'Glam Rock', warmth: 7, intensity: 7, order: 6, groove: 8, nostalgia: 6, texture: 9, inward: 1, melancholy: 4, space: 6, aura: 9, tags: '戏剧、华丽、舞台人格' },
  ...
  { name: '🌫️ 梦幻流行', en: 'Dream Pop', warmth: 8, intensity: 4, order: 4, groove: 2, nostalgia: 7, texture: 9, inward: 8, melancholy: 8, space: 8, aura: 4, tags: '朦胧、梦幻、氤氲' },
  ...
  { name: '🎶 流行摇滚', en: 'Pop Rock', warmth: 6, intensity: 5, order: 5, groove: 6, nostalgia: 6, texture: 5, inward: 6, melancholy: 4, space: 6, aura: 5, tags: '明亮、上口、清爽' },
  { name: '🎪 巴洛克流行', en: 'Baroque Pop', warmth: 5, intensity: 6, order: 9, groove: 4, nostalgia: 7, texture: 9, inward: 4, melancholy: 4, space: 5, aura: 8, tags: '华丽、繁复、戏剧' },
  ...
  { name: '🪩 迪斯科', en: 'Disco', warmth: 8, intensity: 8, order: 5, groove: 10, nostalgia: 9, texture: 9, inward: 1, melancholy: 1, space: 2, aura: 7, tags: '复古、律动、华丽' },
  ...
  { name: '🎵 流行', en: 'Pop', warmth: 9, intensity: 5, order: 5, groove: 6, nostalgia: 4, texture: 8, inward: 3, melancholy: 2, space: 4, aura: 6, tags: '明快、上口、亲和' },
  ...
  { name: '🎷 爵士融合', en: 'Jazz Fusion', warmth: 5, intensity: 6, order: 7, groove: 10, nostalgia: 5, texture: 8, inward: 6, melancholy: 3, space: 7, aura: 6, tags: '跨界、复杂、实验' },
  { name: '🪕 三角洲蓝调', en: 'Delta Blues', warmth: 5, intensity: 4, order: 3, groove: 3, nostalgia: 9, texture: 2, inward: 6, melancholy: 10, space: 4, aura: 2, tags: '原始、粗粝、苦难' },
  ...
  { name: '🪘 非洲律动', en: 'Afrobeat', warmth: 6, intensity: 7, order: 5, groove: 10, nostalgia: 6, texture: 4, inward: 2, melancholy: 1, space: 3, aura: 9, tags: '多节奏、政治、不息' },
  { name: '🌹 探戈', en: 'Tango', warmth: 7, intensity: 8, order: 9, groove: 8, nostalgia: 8, texture: 8, inward: 7, melancholy: 9, space: 3, aura: 6, tags: '张力、戏剧、克制' },

  // —— 四、嘻哈与说唱（5）——
  { name: '🥁 Boom Bap', en: 'Boom Bap', warmth: 6, intensity: 7, order: 4, groove: 8, nostalgia: 9, texture: 5, inward: 6, melancholy: 6, space: 4, aura: 5, tags: '老派、采样、黄金' },
  ...
  { name: '🌑 Phonk', en: 'Phonk', warmth: 2, intensity: 7, order: 3, groove: 6, nostalgia: 9, texture: 4, inward: 7, melancholy: 10, space: 7, aura: 4, tags: '地下、怀旧、深夜' },

  // —— 五、电子音乐（11）——
  { name: '🌌 氛围音乐', en: 'Ambient', warmth: 3, intensity: 1, order: 3, groove: 1, nostalgia: 2, texture: 6, inward: 10, melancholy: 6, space: 10, aura: 6, tags: '留白、无我、弥漫' },
  { name: '🧠 智能舞曲', en: 'IDM', warmth: 3, intensity: 5, order: 9, groove: 4, nostalgia: 2, texture: 9, inward: 9, melancholy: 5, space: 8, aura: 4, tags: '复杂、聆听、大脑' },
  ...
  { name: '🌐 迷幻舞曲', en: 'Trance', warmth: 5, intensity: 9, order: 5, groove: 8, nostalgia: 3, texture: 7, inward: 2, melancholy: 1, space: 4, aura: 9, tags: '亢奋、旋律、飞翔' },
  ...
  { name: '🌆 合成器浪潮', en: 'Synthwave', warmth: 3, intensity: 7, order: 6, groove: 9, nostalgia: 9, texture: 9, inward: 5, melancholy: 7, space: 3, aura: 9, tags: '复古未来、霓虹、速度' },
  ...
  { name: '🎞️ 神游舞曲', en: 'Trip-hop', warmth: 2, intensity: 5, order: 6, groove: 3, nostalgia: 6, texture: 9, inward: 7, melancholy: 10, space: 9, aura: 4, tags: '黑暗、电影感、慢速' },

  // —— 六、古典与跨界（4）——
  { name: '🎻 浪漫主义古典', en: 'Romantic Classical', warmth: 6, intensity: 9, order: 9, groove: 3, nostalgia: 8, texture: 9, inward: 8, melancholy: 8, space: 6, aura: 9, tags: '情感、戏剧、奔涌' },
  ...
  { name: '🏺 新古典', en: 'Neoclassical', warmth: 2, intensity: 3, order: 9, groove: 3, nostalgia: 6, texture: 6, inward: 10, melancholy: 7, space: 8, aura: 6, tags: '古典骨架、现代血肉' },
  { name: '✨ 古典跨界', en: 'Classical Crossover', warmth: 6, intensity: 8, order: 8, groove: 6, nostalgia: 7, texture: 8, inward: 4, melancholy: 4, space: 3, aura: 10, tags: '宏大、通俗、融合' },

  // —— 七、其他现代风格（5）——
  { name: '📼 低保真', en: 'Lo-fi', warmth: 6, intensity: 2, order: 2, groove: 4, nostalgia: 10, texture: 3, inward: 7, melancholy: 5, space: 6, aura: 3, tags: '怀旧、毛边、放松' },
  ...
  { name: '🍀 凯尔特音乐', en: 'Celtic', warmth: 6, intensity: 5, order: 4, groove: 7, nostalgia: 9, texture: 4, inward: 6, melancholy: 8, space: 8, aura: 9, tags: '民族、根源、乡愁' },

...
module.exports = [
  ...
  { id: 3, format: 'glow', context: null,
    prompt: '黄昏的光落在手边的两只杯子上，一只光滑精致，一只粗粝带手作纹路。',
    options: [
      { id: 'A', text: '你拿起光滑那只，喜欢它被打磨得恰到好处。', vector: { texture: 3 } },
      { id: 'B', text: '你拿起粗粝那只，喜欢它不修饰、真实的样子。', vector: { warmth: 2, nostalgia: 1 } },
      { id: 'C', text: '你两只都喜欢，各有各的好。', vector: { warmth: 1, order: 1 } },
      { id: 'D', text: '你没在意杯子，光顾着看那束光了。', vector: { space: 2 } },
    ] },
  ...
  { id: 13, format: 'night', context: null,
    prompt: '深夜里，你翻到一叠旧照片，有些边角磨得起毛，有些还像新的一样挺括。',
    options: [
      { id: 'A', text: '你喜欢那些磨得起毛的，它们带着被摸过的痕迹。', vector: { nostalgia: 2, warmth: 1 } },
      { id: 'B', text: '你喜欢那些还挺括的，像时光没有磨损它们。', vector: { texture: 3 } },
  ...
  { id: 18, format: 'night', context: null,
    prompt: '夜色像一块旧绸缎，有的地方光滑，有的地方起了毛边。',
    options: [
      { id: 'A', text: '你喜欢那光滑的部分，像被打磨过的黑。', vector: { texture: 3 } },
      { id: 'B', text: '你喜欢那毛边的部分，它更真实、更旧。', vector: { nostalgia: 2, warmth: 1 } },
      { id: 'C', text: '你分不清，只觉得夜很深、很静。', vector: { space: 2, melancholy: 1 } },
      { id: 'D', text: '你没留意夜色是什么质感。', vector: {}, avoid: true },
    ] },
  ...
  { id: 29, format: 'drift', context: null,
    prompt: '你的指尖先后碰到两样东西：一块打磨光滑的玉，和一块粗糙的麻布。',
    options: [
      { id: 'A', text: '你反复摩挲那块玉，喜欢它的温润光滑。', vector: { texture: 3 } },
      { id: 'B', text: '你把麻布贴在脸上，喜欢它粗粝的真实。', vector: { warmth: 2, nostalgia: 1 } },
      { id: 'C', text: '你两样都摸摸，各有各的质感。', vector: { texture: 1, order: 1 } },
      { id: 'D', text: '你缩回手，对这些物件没感觉。', vector: { order: 1 } },
    ] },
